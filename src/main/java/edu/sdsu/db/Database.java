...
public class Database {
   private String name;
   private HashMap<String, Collection> tableHashMap;
   ...
   public Collection createTable(String tableName) {
   ...
   public HashMap<String, Collection> getTableHashMap() {
      return tableHashMap;
   }

   public void setTableHashMap(HashMap<String, Collection> tableHashMap) {
